...
public class FontSizePage extends JPanel {
    ...
    public FontSizePage(MainApp mainApp) {
    ...
    private void setupUI() {
        ...
        for (int i = 0; i < imageIcons.length; i++) {
            imageIcons[i] = new ImageIcon("fontsize" + (i + 1) + ".png"); // 이미지 파일의 경로 지정
        }
        ...
        quizButton.addActionListener(e -> mainApp.showFontSizeQuizPage()); // 퀴즈 페이지로 이동
