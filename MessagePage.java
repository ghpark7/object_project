...
public class MessagePage extends JPanel {
    ...
    public MessagePage(MainApp mainApp) {
    ...
    private void setupUI() {
        ...
        //위에 큰 제목
        JLabel titleLabel = new JLabel("    메시지 보내는 방법", JLabel.CENTER);
        ...
        for (int i = 0; i < imageIcons.length; i++) {
            imageIcons[i] = new ImageIcon("message" + (i + 1) + ".png"); // 이미지 파일의 경로 지정
        }
        ...
        quizButton.addActionListener(e -> mainApp.showMessageQuizPage()); // 퀴즈 페이지로 이동
